...
class NoteRNNLoader(object):
  ...
  def __init__(self, graph, scope, checkpoint_dir, checkpoint_file=None,
    ...
    """
   # print("note_rnn_loader / : ",inspect.stack()[0][3])
    self.graph = graph
    self.session = None
    self.scope = scope
    self.batch_size = 1
    ...
    #print("State value", self.state_value.shape[1])
  ...
  def get_zero_state(self):
    ...
    """
    #print("note_rnn_loader / : ",inspect.stack()[0][3])
    #print(np.zeros((self.batch_size, self.cell.state_size)))
  ...
  def run_training_batch(self):
   ...
   # print("note_rnn_loader / : ",inspect.stack()[0][3])
    ...
    coord.request_stop()
    #print("softmax, state, lengths", softmax, state, lengths)
